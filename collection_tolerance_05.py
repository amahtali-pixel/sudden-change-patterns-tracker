...
def cluster_patterns_simple(patterns, tolerance=0.15):  # Changed tolerance from 0.25 to 0.1
...
def save_clustered_patterns(clustered_patterns, class_digit, filename_prefix="clustered_0.25"):  # Changed prefix to include tolerance
    ...
    sample_filename = f"clustered_0.50_{class_digit}_samples.txt"  # Changed to include tolerance
...
def process_class(class_digit, device='cuda', tolerance=0.15):  # Changed default tolerance to 0.38
...
def main():
    ...
    tolerance = 0.15  # Changed tolerance from 0.1 to 0.15
