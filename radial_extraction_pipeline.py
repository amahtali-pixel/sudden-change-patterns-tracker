...
# - Clusters with tolerance=0.12 (strict similarity threshold)
...
def cluster_patterns_simple(patterns, tolerance=0.12):  # Changed tolerance from 0.15 to 0.12
    ...
    # Convert to numpy for easier processingb
...
def save_clustered_patterns(clustered_patterns, class_digit, filename_prefix="clustered_012"):  # Changed prefix to include tolerance
    ...
    sample_filename = f"clustered_012_{class_digit}_samples_012.txt"  # Changed to include tolerance
...
def process_class(class_digit, device='cuda', tolerance=0.12):  # Changed default tolerance to 0.38
...
def main():
    ...
    tolerance = 0.12  # Changed tolerance from 0.15 to 0.12
